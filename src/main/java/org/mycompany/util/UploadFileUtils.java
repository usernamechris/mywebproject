...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath,
		...
		if (MediaUtils.getMediaType(formatName) != null) {
			...
			uploadedFileName = MarkerIcon(uploadPath, savedPath, savedName);
		}
		
		return uploadedFileName;
	}

	private static String MarkerIcon(String uploadPath, String path, String fileName) throws Exception {
		String iconName = 
